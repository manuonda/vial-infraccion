...
class Ion_auth {
     ...
     * @author Mathew
     * */
    public function register($cuil, $username, $password, $email, $additional_data = array(), $group_name = array()) { //need to test email activation
        ...
        if (!$email_activation) {
            ...
            $id = $this->ion_auth_model->register($cuil, $username, $password, $email, $additional_data, $group_name);
            if ($id !== FALSE) {
     ...
     * @author Mathew
     * */
    public function check_session($identity, $password) {
        $this->load->model('admin/session_model');
        if ($this->ion_auth_model->user_exist($identity, $password)) {
            return (bool) $this->session_model->check_session($identity);
        }else{
            return FALSE;
        }
    }
     ...
     * @return type 
     */
    public function convert_to_array($objetos = null, $id = null) {
        $array = array();
        $i = 0;
