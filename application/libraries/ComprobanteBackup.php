...
class Comprobante {
   ...
   public function getComprobante($idInfraccionPagoCuota,$username){
    ...
    echo "<br>";
    echo 'cuil_involucrado : '.$this->getCuit($infraccion->cuil_involucrado). 'cant : '.strlen($this->getCuit($infraccion->cuil_involucrado));
    echo '<br>';
    ...
    */
     ...
     $style = array(
       ...
       $paramsGeneral     = $pdf->serializeTCPDFtagParameters(array($codigoBarraGeneral, 'I25+', '', '', 140, 20, 0.3, $style, 'N'));
       $paramsAlcoholemia = $pdf->serializeTCPDFtagParameters(array($codigoBarraAlcoholemia, 'I25+', '', '', 140, 20, 0.3, $style, 'N'));
  ...
  private function get_pdfGeneral($configuracion,$involucrado,$domicilio,$infraccion,$infraccionPago,$infraccionPagoCuota,$leyes,$tipovehiculo,$marca,$modelo,$configuracion,$username ,$barraGeneral, $barraAlcoholemia ,$codigoBarraGeneral) {
      ...
      $html = '  <table border="0" style="border:1px solid #000000;" >
                  ...
                  <img  height="50" src="http://turnospolicia.jujuy.gob.ar/pagina_files/img/logo-jujuy-negro.png">
                  </div>
                  </td>
                  <td width="10%"></td>
                  <td width="30%"></td>
                  ...
                  <img  height="50" src="http://turnospolicia.jujuy.gob.ar/pagina_files/img/escudo-negro.png">
                  </div>
                  </td>
                  </tr>
