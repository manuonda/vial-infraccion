...
class Comprobantecontado  {
   ...
   public function getComprobante($idInfraccionPagoCuota,$username){
    ...
    $codigoBarraAlcoholemia = $codigoBarraAlcoholemia. $this->getDigitoVerificador($codigoBarraAlcoholemia);
     ...
     echo "codigo barra general : ".$codigoBarraGeneral;
     echo "<br>";
     echo "codigo barra alcoholemia " .$codigoBarraAlcoholemia;
     ...
     ob_start();
      ...
      $pdf = new TCPDF(); 
       ...
       $paramsGeneral     = $pdf->serializeTCPDFtagParameters(array($codigoBarraGeneral, 'I25', '30', '120', '',15,0.4, $style, 'N'));
       $paramsAlcoholemia = $pdf->serializeTCPDFtagParameters(array($codigoBarraAlcoholemia, 'I25', '30', '120', '', 15, 0.4, $style, 'N'));
