...
*/
$config['tables']['users']              = 'public.usuarios';
$config['tables']['groups']             = 'public.roles';
$config['tables']['users_groups']       = 'public.usuarios_roles';
$config['tables']['login_attempts']     = 'login_fallidos';

$config['tables']['grupo_secciones']    = 'grupo_secciones';
$config['tables']['secciones']          = 'secciones';
$config['tables']['permisos']           = 'permisos';
$config['tables']['persona']            = 'personas';
$config['tables']['personal']           = 'personal';
$config['tables']['grupos']             = 'grupos';

$config['tables']['sRevista']           = 'situaciones_revistas';
$config['tables']['tRevista']           = 'tipo_revistas';
$config['tables']['tsRevista']          = 'tipo_situaciones_revistas';
$config['tables']['aFamiliar']          = 'asistencias_fliares';
$config['tables']['pEnfermo']           = 'partes_enfermos';
$config['tables']['jMedica']            = 'jm_policiales';
$config['tables']['teJuntaMedica']      = 'tipo_estados_junta_medica';
$config['tables']['comercio']           = 'comercios';
$config['tables']['domicilio']           = 'domicilios';
$config['tables']['actividad']           = 'actividades';
$config['tables']['servicio']           = 'adicional.servicios';
$config['tables']['servicioDia']        = 'adicional.servicioDias';
$config['tables']['servicioPostularDia']        = 'adicional.servicioPostularDias';
...
$config['join']['groups'] = 'id_rol';
$config['join']['estId'] = 'est_id';
 ...
 */
/*
$config['message_start_delimiter'] = '<p><span class="info-msg">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</span></p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p><span class="info-error">';		// Error mesage start delimiter
