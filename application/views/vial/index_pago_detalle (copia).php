    ...
    <div class="portlet-body form">
        ...
        <div class="form-body">                    
                            ...
                            <table  id="tabla-cuotas" class="table table-striped table-bordered table-hover table-checkable order-column" id="tableDetalle">
                                ...
                                <?php foreach($pagos as $pago): ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td><div class="text-center"><strong><?php echo "$".$pago->importe_general ;?></strong></div></td>
                                        <td><div class="text-center"><strong><?php echo "$".$pago->importe_alcoholemia; ?></strong></div></td>
                                        <td>
                                        <div class='text-center'>
                                          <?php 
                                            if($infraccionPago->tipo_pago =='TIPO_PAGO_CONTADO'){
                                                 echo "<button type='button' onclick='module_detalle_pago.generarComprobanteContado(".$pago->id.");return false;' class='btn default btn-xs blue' >COMPROBANTE CONTADO</button>";
                                            
                                                 
                                            }else if($infraccionPago->tipo_pago =='TIPO_PAGO_CUOTAS'){ 
                                            echo "<button type='button' onclick='module_detalle_pago.generarComprobanteCuota(".$pago->id.");return false;' class='btn default btn-xs blue' >COMPROBANTE CUOTA</button>";
            ...
            <div class="form-actions right">
                ...
                <button type="button" class="btn red" onclick='if(confirm("Desea eliminar el Pago ? ")); module_detalle_pago.eliminarPago(<?php echo $infraccionPago->id_infraccion_pago;?>)'>
