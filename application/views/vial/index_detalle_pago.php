                            ...
                            <table  id="tabla-cuotas" class="table table-striped table-bordered table-hover table-checkable order-column" id="tableDetalle">
                                ...
                                <?php foreach($pagos as $pago): ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        <div class='text-center'>23423
                                          
                                          <?php 
                                          echo $infraccionPago->tipo_pago;
                                            if($infraccionPago->tipo_pago =='TIPO_PAGO_CONTADO' ||  $infraccionPago->tipo_pago =='TIPO_PAGO_TARJETA' ){
                                                 echo "<button type='button' onclick='module_detalle_pago.generarComprobanteContado(".$pago->id.");return false;' class='btn default btn-xs blue' > GENERAR COMPROBANTE CONTADO</button>";
                                            
                                                 
                                            }else if($infraccionPago->tipo_pago =='TIPO_PAGO_CUOTAS'){ 
                                            echo "<button type='button' onclick='module_detalle_pago.generarComprobanteCuota(".$pago->id.");return false;' class='btn default btn-xs blue' >GENERAR COMPROBANTE CUOTA</button>";
