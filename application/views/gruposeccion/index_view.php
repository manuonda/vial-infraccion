...
<div class="row">
  ...
  <i class="fa fa-file-text-o font-orange"></i> <span
    class="caption-subject bold uppercase"> Buscar Grupo Seccion</span></div>
  <div class="tools">
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a href="<?php echo base_url(); ?>admin/GrupoSeccion/agregar" id="sample_editable_1_new" class="btn sbold green"> Agregar
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="table_perfil">
                                            ...
                                            <tbody>
                                              ...
                                              <?php foreach($gruposeccion as $grupo): ?>
                                                ...
                                                <tr class="odd gradeX">
                                                  ...
                                                  <div class="text-center">
                                                    <a title="Editar"
                                                       href='<?php echo base_url().'gruposeccion/editar/'.$grupo->id;?>'
