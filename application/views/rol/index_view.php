...
<div class="row">
  ...
  <i class="fa fa-file-text-o font-orange"></i> <span
    class="caption-subject bold uppercase"> Buscar Rol</span></div>
  <div class="tools">
  ...
  <?php echo form_open_multipart('perfil/buscar', 'class="horizontal-form"'); ?>
  <div class="row">
  <div class="col-md-3">
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="btn-group">
                                                        <a href="<?php echo base_url(); ?>rol/agregar" id="sample_editable_1_new" class="btn sbold green"> Agregar
                                              ...
                                              <?php foreach($roles as $rol): ?>
                                                ...
                                                <tr class="odd gradeX">
                                                  ...
                                                  <div class="text-center">
                                                    <button 
                                                     type="button"
                                                     onclick="showModalView(<?php echo $rol->id;?>);" 
                                                     class="btn default btn-xs red"> 
                                                     <i class="fa fa-eye"></i> 
                                                    </button>
                                                    <a title="Editar"
                                                       href='<?php echo base_url().'rol/editar/'.$rol->id;?>'
