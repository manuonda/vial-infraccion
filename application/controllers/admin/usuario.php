...
class Usuario extends MY_Controller {
    ...
    function __construct() {
      ...
      //  $this->load->library('fechautil');
        ...
        $this->data['jScript'] = array('template/plugins/bootstrap-daterangepicker/moment.min.js', 'template/plugins/bootstrap-daterangepicker/daterangepicker.js', 'template/plugins/bootstrapvalidator/bootstrapValidator.js',
            'template/plugins/bootstrapvalidator/language/es_ES.js', 'template/plugins/select2/select2.min.js', 'template/js/jquery.numeric.min.js', 'template/js/custom.js', 'template/plugins/datatables/dataTables.bootstrap.min.js', 'template/plugins/datatables/jquery.dataTables.min.js');
        $this->data['cssTemplate'] = array('template/plugins/daterangepicker/daterangepicker.css', 'template/plugins/bootstrapvalidator/bootstrapValidator.css', 'template/plugins/select2/select2.css', 'template/dist/css/customForm.css', 'template/plugins/datatables/jquery.dataTables.css');

        $this->data['options'] = $this->comisaria->convert_to_array_select($this->ion_auth->groups()->result(), 'id', 'name', '-- Selecione Rol --');
        $this->data['grupoSeccion'] = 'Usuarios';
    }
